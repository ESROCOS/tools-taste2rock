...
cd "$SKELS" && rm -f taste2rock_test1_producer.zip && zip taste2rock_test1_producer taste2rock_test1_producer/* && cd $OLDPWD

cd "$SKELS" && rm -f taste2rock_test1_consumer.zip && zip taste2rock_test1_consumer taste2rock_test1_consumer/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subC taste2rock_test1_producer:"$SKELS"/taste2rock_test1_producer.zip \
	--subC taste2rock_test1_consumer:"$SKELS"/taste2rock_test1_consumer.zip \
